...
import { SponsorLink } from "@/components/base";
...
const convex: Sponsor = {
  link: "https://convex.dev/c/wHACKiest",
  alt: "Convex logo",
  src: Convex,
  title: "Convex",
  text: (
    <TextDiv>
      ...
      <ArrowLinkStyled>
        <SponsorLink
          href="https://convex.dev/c/wHACKiest"
          target="_blank"
          rel="noreferrer"
        >
          Company Website
...
const deshaw = {
  link: "https://www.deshaw.com/recruit/internships/Sponsorship/WHACKiest",
  alt: "D. E. Shaw logo",
  src: DEShaw,
  title: "D. E. Shaw",
};
