...
wHACKiest does require cookies to be enabled for our services to work. We do not, however, have individual control over cookies and other tracking activities done by the services outlined in [Data we collect when you visit our website](#data-we-collect-when-you-visit-our-website). You may elect to use a browser extension to block these anonymous analytics activities.

## Questions
We are always looking for feedback on our practices and policies at wHACKiest. If you have any questions, concerns, or complaints regarding our practices or policies please contact us at [hello@coderit.org](mailto:hello@coderit.org). 
`;
