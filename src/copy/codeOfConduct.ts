...
All individuals present at wHACKiest are expected to uphold and abide by this policy, by refraining from any form of harassment or discrimination, and by cooperating fully in any investigation of a harassment or discrimination complaint. wHACKiest looks to its attendees and Organizers to uphold the environment of diversity and inclusivity that is valued in the organization.
...
wHACKiest is an MLH member event. As part of our partnership, the [MLH Code of Conduct](https://static.mlh.io/docs/mlh-code-of-conduct.pdf) also applies to all wHACKiest attendees.
`;
